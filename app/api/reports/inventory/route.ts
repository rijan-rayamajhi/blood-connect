...
export async function GET(request: Request) {
    try {
        ...
        // Admin can request any org's data, otherwise it's self-filtered via RPC
        ...
        if (format === 'csv') {
            ...
            return new NextResponse(csv, {
                ...
                headers: {
                    ...
                    'Content-Disposition': `attachment; filename="inventory_report_${startDate}_to_${endDate}.csv"`,
                },
            })
        }
